...
const ASSETS: &[Asset] = &[
    ...
    asset!(
        ...
        "../../assets/js/charts/sparkline.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/linechart.js",
        "../../assets/js/charts/linechart.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/gauge.js",
        "../../assets/js/charts/gauge.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/bars.js",
    ...
    asset!(
        ...
        "../../assets/js/charts/heatmap.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/areachart.js",
        "../../assets/js/charts/areachart.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/donut.js",
    ...
    asset!(
        "/js/charts/radialgauge.js",
        "../../assets/js/charts/radialgauge.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/charts/stackedbars.js",
        "../../assets/js/charts/stackedbars.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
    ...
    asset!(
        ...
        "../../assets/js/components/primitives.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
    ...
    asset!(
        "/js/components/datatable2.js",
        "../../assets/js/components/datatable2.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
    ...
    asset!(
        "/js/views/cpu.js",
        "../../assets/js/views/cpu.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/memory.js",
        "../../assets/js/views/memory.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/network.js",
    ...
    asset!(
        "/js/views/disk.js",
        "../../assets/js/views/disk.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/processes.js",
        "../../assets/js/views/processes.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/thermal.js",
        "../../assets/js/views/thermal.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/alerts.js",
        "../../assets/js/views/alerts.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/info.js",
        "../../assets/js/views/info.js",
        "application/javascript; charset=utf-8"
    ),
    asset!(
        "/js/views/profile.js",
...
fn serve(path: &str) -> Response {
    match lookup(path) {
        Some(asset) => {
            ...
            resp.body(axum::body::Body::from(asset.bytes))
        ...
        None => {
            ...
            match lookup("/index.html") {
                Some(shell) => Response::builder()
                    ...
                    .body(axum::body::Body::from(shell.bytes))
                    .unwrap_or_else(|_| StatusCode::INTERNAL_SERVER_ERROR.into_response()),
